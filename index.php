...
<body class="d-flex flex-column h-100">
    ...
    <div class="position-relative d-flex text-center text-white promo-banner-bg py-3">
        <div class="p-lg-2 mx-auto my-5">
            <h1 class="display-5 fw-normal">Welcome to Canteen Delivery System</h1>
            <p class="lead fw-normal">Food ordering system of DBCE Canteen</p>
        </div>
    </div>

    <div class="container p-5" id="recommended-shop">
        <h2 class="border-bottom pb-2"><i class="bi bi-shop align-top"></i> Canteen</h2>
    ...
    <footer
        ...
        <span class="smaller-font">&copy;SE Comp<br /><span class="xsmall-font">Gavin, Langer, Samuel</span></span>
        <ul class="nav justify-content-end list-unstyled d-flex">
            <li class="ms-3"><a class="text-light" target="_blank" href="https://github.com/Gavin9307/Canteen-Delivery-System"><i
